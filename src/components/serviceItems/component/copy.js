...
import { PullToRefresh, ListView, Button ,Toast,Carousel, WingBlank} from 'antd-mobile';
...
class App extends React.Component {
    ...
    _renderRow(row, sectionId, rowId) {
      ...
      >
        <div onClick={this.gotoDetail.bind(this, row.id)} >
                                <div className="service_pic_box">
                                    <img style={{ width: '100%', display: 'block' }} src={row.clisPic} />
                                    <div className="service_name">{row.clisName}</div>
                                </div>
                                {row.clisPrice ?(
        ...
        {/* <div  onClick={this.gotoDetail.bind(this,row.id)} style={{ display: '-webkit-box', display: 'flex', padding: '15px',flexDirection:'row' }}>
          ...
          <div style={{ flex:'1',width:'0'}}>
            ...
            <div style={{  marginTop:'10px'}}><span className="money" style={{ fontSize: '16px', color: '#FF6E27' }}>
