...
//有用的图片
import time from '../../../static/images/toothType3/home/time_bg.png'
import address from '../../../static/images/toothType3/home/address_bg.png'
import classify from '../../../static/images/toothType3/home/classify.png'
import oneKey from '../../../static/images/toothType3/home/onekey.png'
import doctorTeam from '../../../static/images/toothType3/home/doctorTeam.png'
import wifi from '../../../static/images/toothType3/home/wifi.png'
import introduce from '../../../static/images/toothType3/home/introduce.png'
import casePic from '../../../static/images/toothType3/home/case.png'
import tongmei from '../../../static/images/common/tongmei.jpg'
import attitude from '../../../static/images/toothType3/home/attitude.png'
import equipment from '../../../static/images/toothType3/home/equipment.png'
import environment from '../../../static/images/toothType3/home/environment.png'
...
class Content extends React.Component {
    ...
    goEnvironment(){
             document.getElementById("environmentScroll").scrollIntoView();
             if( this.props.state.clinicMess.clinicId=='117818'){
                    this.goIntroduce()
             }
    }
    zhankai = (index) => {
    ...
    //跳转到设备
    goEquipment(){
        window.location.href="https://mp.weixin.qq.com/s?__biz=MzUxNzcwOTQ1MA==&mid=100000034&idx=1&sn=2cc955b3f24ff08f214a823229126dcc&chksm=79954ac74ee2c3d1c9353ae4afc5a7ed32a93bb0d16a5b377e4c1450622537a0d5657a54ad1f#rd"
    }
    //跳转到态度界面
    goAttitude(){
        window.location.href="https://mp.weixin.qq.com/s?__biz=MzUxNzcwOTQ1MA==&mid=100000049&idx=1&sn=fdc84dcc3d0ae7759fd3df2f8de9dd78&chksm=79954ad44ee2c3c2f88612cbb04fb7a2318cd94e48a0cded0f6a43d1a374460dc86b9b7e0571#rd"
    }
    bihe = (index) => {
        this.setState({
            currentIndex: index
        ...
        return (
            <div className="type444" style={{width:'100%',overflowX:'hidden'}}>
                ...
                <div className="flex_wrap" style={{ paddingTop: '40px',paddingBottom:'40px'}}>
                    ...
                    <div className="width_50 flex_column al_center" style={{marginBottom:'10px'}}>
                        <img src={casePic} style={{ width: '90%' }} onClick={this.goCase.bind(this)} />
                    </div>
                    {
                   this.props.state.clinicMess.clinicId=='117818'&& 
                    <div className="width_50 flex_column al_center" style={{marginBottom:'10px'}}>
                        <img src={attitude} style={{ width: '90%' }} onClick={this.goAttitude.bind(this)} />
                    </div>
                      }
                        {
                   this.props.state.clinicMess.clinicId=='117818'&& 
                    <div className="width_50 flex_column al_center" style={{marginBottom:'10px'}}>
                        <img src={equipment} style={{ width: '90%' }} onClick={this.goEquipment.bind(this)} />
                    </div>
                        }
                  
                    <div className="width_50 flex_column al_center" style={{marginBottom:'10px'}}>
                        <img src={environment} style={{ width: '90%' }} onClick={this.goEnvironment.bind(this)} />
                    </div>
                </div>
                {
                 ...
                 <div className="flex_wrap">
                 {
                        this.props.state.serviceList.map((val,index)=>( 
                            ...
                            {(index+1)%4==1 && (
                                <div className="width_100 flex_column al_center pos_rel"  style={{marginBottom:'10px',paddingTop:'100%'}}>
                                    ...
                                    <div style={{width:'20%',paddingTop:'20%',borderRadius:'50%',position:'absolute',left:'13%',top:'8%',border:'4px solid #fde004',opacity:'.3'}}></div>
                                    <div className="commonBg" style={{width:'80%',paddingTop:'80%',borderRadius:'50%',position:'absolute',right:'6%',top:'14%'}}></div>
                                    <div onClick={this.gotoDetail.bind(this,val.id, val.clisName)} style={{width:'75%',paddingTop:'75%',borderRadius:'50%',background:'url('+(val.clisIcon?val.clisIcon:val.clisPic)+') no-repeat center',backgroundSize:'110%',position:'absolute',right:'7%',top:'17%'}}></div>
                            ...
                            {(index+1)%4==2 && (
                                ...
                                <div style={{width:'78%',paddingTop:'78%',borderRadius:'50%',position:'absolute',left:'2%',top:'18%',border:'4px solid #fde004',opacity:'.3'}}></div>
                                <div className="commonBg" style={{width:'80%',paddingTop:'80%',borderRadius:'50%',position:'absolute',right:'13%',top:'20%'}}></div>
                                <div onClick={this.gotoDetail.bind(this,val.id, val.clisName)} style={{width:'75%',paddingTop:'75%',borderRadius:'50%',background:'url('+(val.clisIcon?val.clisIcon:val.clisPic)+') no-repeat center',backgroundSize:'110%',position:'absolute',right:'14%',top:'19%'}}></div>
                            ...
                            <div className="width_100 flex_column al_center pos_rel"  style={{marginBottom:'10px',paddingTop:'100%'}}>
                                    ...
                                    <div onClick={this.gotoDetail.bind(this,val.id, val.clisName)} style={{width:'75%',paddingTop:'75%',borderRadius:'50%',background:'url('+(val.clisIcon?val.clisIcon:val.clisPic)+') no-repeat center',backgroundSize:'110%',position:'absolute',right:'6%',top:'9%'}}></div>      
                                    <div style={{textAlign:'center'}} className="clisName_box">{val.clisName}</div>
                            </div>
                            )
                        }
                        ...
                        <div style={{width:'20%',paddingTop:'20%',borderRadius:'50%',position:'absolute',right:'-5%',top:'18%',border:'4px solid #fde004',opacity:'.3'}}></div>
                        <div className="commonBg" style={{width:'80%',paddingTop:'80%',borderRadius:'50%',position:'absolute',left:'0%',top:'20%'}}></div>
                        <div onClick={this.gotoDetail.bind(this,val.id, val.clisName)} style={{width:'75%',paddingTop:'75%',borderRadius:'50%',background:'url('+(val.clisIcon?val.clisIcon:val.clisPic)+') no-repeat center',backgroundSize:'110%',position:'absolute',left:'0%',top:'25%'}}></div>      
                                <div style={{textAlign:'center',marginTop:'15px'}} className="clisName_box">{val.clisName}</div>
                        </div>
               ...
               <div className="team_box" style={{background:'transparent'}}>
                   {this.props.state.doctorList.map((val, index) => (
                       <div className="team_content flex_row" key={index} onClick={this.handleClick.bind(this, val.doctorId)}  style={{border:0}}>
                           <div className="team_content_left flex_1" style={{position:'relative'}}>
                               <img style={{ width: '100%', display: 'block' }} src={val.headUrl} />
                               <div className="commonBg" style={{color:'#fff',padding:'5px 0',textAlign:'center',position:'absolute',width:'100%',bottom:'10px'}}>查看详情</div>
                           </div>
               ...
               <div className="introduce_box" style={{background:'transparent',lineHeight:'26px',fontSize:'15px'}}>
                ...
                <div>
                    {this.props.state.clinicEnvironmentList.length > 0 &&
                            <div  id="environmentScroll" className="flex_row  al_center just_content_center" style={{background:'url('+classify+') no-repeat center',paddingBottom:'25px',paddingTop:'17px',backgroundSize:'87% 100%',fontSize:'20px',color:'#fff'}}>
                                    门诊环境
                            </div>
                    }
