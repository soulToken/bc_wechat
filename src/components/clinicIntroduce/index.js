        ...
        return(
            ...
            <div className="introduce_top">
               {this.state.headUrl &&
                    <img className="introduce_banner"  src={this.state.headUrl} />
                        ...
                        <div className="introduce_bottom">
                            <div className="introduce_con">
                                ...
                                <div className="introduce_con_c noLineHeight">
                                            <img  src={address} />
                                            <span className="intruduce_address" style={{ WebkitBoxOrient: 'vertical'}}>
                                                {this.state.city+this.state.area+this.state.address}
                                            </span>
                ...
                <div className="introduce_title">门诊介绍</div>
                <div  className="clinic_introduce_content">
                   {this.state.clinicIntroduce}
                </div>
                <div className="under_line"></div>
                <div className="introduce_title2">门诊环境</div>
                {this.state.clinicEnvironmentList.map((index,item) =>
     
                    <div className="introduce_pic" key={item}  onClick={this.previewImage.bind(this,index)}>
