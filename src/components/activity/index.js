    ...
    return (
      <div key={row.id}
        ...
        >
          ...
          <div style={{ display: '-webkit-box', display: 'flex', padding: '10px' }}    onClick={this.getClick.bind(this,row.id)}>
            <img style={{ height: '200px', width:'100%' ,border:"1px solid #dbdbdb"}} src={row.activityPicture} alt="" />
          </div>
        </div>
    )
  }
